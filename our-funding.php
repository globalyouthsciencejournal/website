...
<head>
  ...
  <title>Our Funding  Global Youth Science Journal | Supporting Open Access</title>
  <meta name="description"
    content="Learn about the funding sources and support behind the Global Youth Science Journal. We are committed to open access for young researchers.">
  <meta name="keywords"
    content="funding, support, open access, Global Youth Science Journal, GYS Journal, research publication, young researchers">
  ...
  <script type="application/ld+json">
    {
      ...
      "@type": "Article",
      "headline": "Our Funding  Global Youth Science Journal",
      "description": "Learn about the funding sources and support behind the Global Youth Science Journal. We are committed to open access for young researchers.",
      "publisher": {
        "@type": "Organization",
        "name": "Global Youth Science Journal",
        "logo": {"@type": "ImageObject", "url": "https://<?php echo $_SERVER["HTTP_HOST"]; ?>/images/logo.png"}
      },
      "mainEntityOfPage": "https://<?php echo $_SERVER["HTTP_HOST"]; ?>/our-funding.php"
    }
    </script>
  <!-- Google tag (gtag.js) -->
  ...
  <link rel="canonical" href="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/our-funding.php" />
  ...
  <meta name="citation_title" content="Our Funding  Global Youth Science Journal">
  <meta name="citation_keywords"
    content="peer-reviewed, open-access, research journal, young scientists, science, technology, engineering, mathematics, STEM, publication, scholarly, academic, global, youth, research paper, submission, journal, scientific publishing, Google Scholar, citation, author guidelines, editorial board, call for papers, free publication, under 20, international, funding">
  <meta property="og:type" content="website">
  <meta property="og:title" content="Our Funding  Global Youth Science Journal">
  <meta property="og:description"
    content="Learn about the funding sources and support for the Global Youth Science Journal.">
  <meta property="og:url" content="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/our-funding.php">
  <meta property="og:image" content="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/images/logo.png">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Our Funding  Global Youth Science Journal">
  ...
  <script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "Our Funding", "item": "https://<?php echo $_SERVER["HTTP_HOST"]; ?>/our-funding.php"}
  ]
}
</script>
  <!-- ScholarlyArticle Schema for funding page -->
  <script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ScholarlyArticle",
  "headline": "Our Funding",
  "name": "Our Funding",
  "description": "Learn about the funding sources and support for the Global Youth Science Journal.",
  ...
  "keywords": ["peer-reviewed", "open-access", "research journal", "young scientists", "funding", "science", "technology", "engineering", "mathematics", "STEM", "academic", "global", "youth", "journal", "Google Scholar", "citation", "author guidelines", "editorial board", "call for papers", "free publication", "under 20", "international"]
}
</script>
  <!-- FAQPage Schema -->
  <script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How is the journal funded?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The journal is supported by grants, donations, and volunteer contributions."
      }
    },
    {
      "@type": "Question",
      "name": "Are there any publication fees?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No, publication is free for all eligible young researchers."
      }
    }
  ]
}
      ...
      <div class="row mx-0">
        <div class="col-md-10 animate-box" data-animate-effect="fadeInLeft">
          ...
          <p style="font-size:1.1em;max-width:800px;">
            The Global Youth Science Journal (GYS Journal) is a non-profit initiative and is intended to remain so. We
            operate transparently, with no publication or access fees, and our infrastructure is supported by free and
            open platforms such as Vercel (for hosting) and Zenodo (for archiving and indexing research). This ensures
            that all research remains freely accessible to everyone, everywhere.
          </p>
          <p style="font-size:1.08em;max-width:800px;">
            <b>We do not solicit or accept funding from outside India.</b> If you wish to support the journal, the only
            way to contribute is via UPI from within India. Your support helps us keep the platform free and open for
            young researchers worldwide.
          </p>
          <div style="margin:24px 0;">
            <b>UPI ID:</b> <span style="font-family:monospace;">tuhinsarkar.in@fam</span>
            <br>
            <span style="display:inline-block;margin-top:12px;">
              <img src="funding.jpg" alt="UPI QR Code for donations"
                style="width:560px;max-width:100%;height:auto;border:1.5px solid #ccc;background:#f9f9f9;object-fit:contain;">
            </span>
            <div style="font-size:0.95em;color:#888;margin-top:8px;">(Scan this QR code with any UPI app to donate)
            </div>
          </div>
          <p style="font-size:1em;max-width:800px;">Thank you for supporting open science and empowering the next
            generation of researchers!</p>
        </div>
      </div>
    </div>
  </div>
  <!-- Announcement Banner: Name Change -->
...
<script src="js/jquery.min.js"></script>
  ...
  <div style="display:none;">
    <span itemprop="citation">Global Youth Science Journal Editorial Board. (2026). Our Funding. Global Youth Science
      Journal. https://<?php echo $_SERVER["HTTP_HOST"]; ?>/our-funding.php</span>
  </div>
  </div>
  </div>
  </div>
