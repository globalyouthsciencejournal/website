...
<head>
  ...
  <title>Contribute | Global Youth Science Journal</title>
      ...
      <div class="row mx-0">
        <div class="col-md-10 animate-box" data-animate-effect="fadeInLeft">
          ...
          <p style="font-size:1.15em;max-width:800px;">
            Support the Global Youth Science Journal by contributing to our platform. We are always looking for volunteers, donors, and organizations to help us keep this platform free and accessible to young researchers worldwide.
          </p>
        </div>
      </div>
    </div>
