...
<head>
  ...
  <title>Author Guidelines  Global Youth Science Journal | Submission Instructions</title>
  <meta name="description"
    content="Learn how to prepare and submit your manuscript to the Global Youth Science Journal. Follow our author guidelines for successful research publication.">
  <meta name="keywords"
    content="author guidelines, submission, manuscript, research paper, Global Youth Science Journal, GYS Journal, publishing, young scientists">
  ...
  <script type="application/ld+json">
    {
      ...
      "@type": "Article",
      "headline": "Author Guidelines  Global Youth Science Journal",
      "description": "Learn how to prepare and submit your manuscript to the Global Youth Science Journal. Follow our author guidelines for successful research publication.",
      "publisher": {
        "@type": "Organization",
        "name": "Global Youth Science Journal",
        "logo": {"@type": "ImageObject", "url": "https://<?php echo $_SERVER["HTTP_HOST"]; ?>/images/logo.png"}
      },
      "mainEntityOfPage": "https://<?php echo $_SERVER["HTTP_HOST"]; ?>/authorguidelines.php"
    }
    </script>
  <!-- Google tag (gtag.js) -->
  ...
  <link rel="canonical" href="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/authorguidelines.php" />
  ...
  <meta name="citation_title" content="Author Guidelines  Global Youth Science Journal">
  ...
  <meta property="og:title" content="Author Guidelines  Global Youth Science Journal">
  <meta property="og:description"
    content="Guidelines for authors submitting to the Global Youth Science Journal. Ensure your research meets our academic standards.">
  <meta property="og:url" content="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/authorguidelines.php">
  <meta property="og:image" content="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/images/logo.png">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Author Guidelines  Global Youth Science Journal">
  ...
  <script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "Author Guidelines", "item": "https://<?php echo $_SERVER["HTTP_HOST"]; ?>/authorguidelines.php"}
  ]
}
</script>
  <!-- ScholarlyArticle Schema for guidelines page -->
  <script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ScholarlyArticle",
  "headline": "Author Guidelines",
  "name": "Author Guidelines",
  "description": "Guidelines for authors submitting to the Global Youth Science Journal. Ensure your research meets our academic standards.",
  ...
  "keywords": ["peer-reviewed", "open-access", "research journal", "young scientists", "author guidelines", "science", "technology", "engineering", "mathematics", "STEM", "academic", "global", "youth", "journal", "Google Scholar", "citation", "call for papers", "free publication", "under 20", "international"]
}
</script>
  <!-- FAQPage Schema -->
  <script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What are the formatting requirements?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Manuscripts must follow the provided template and include all required sections."
      }
    },
    {
      "@type": "Question",
