...
<head>
  ...
  <title>Contact  Global Youth Science Journal | Editorial Office & Support</title>
  <meta name="description"
    content="Contact the Global Youth Science Journal editorial office for inquiries, support, and research submission questions. We're here to help young scientists.">
  <meta name="keywords"
    content="contact, editorial office, support, Global Youth Science Journal, GYS Journal, research submission, young scientists">
  ...
  <!-- Schema.org Contact Structured Data -->
  ...
  <link rel="canonical" href="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/contact.php" />
  ...
  <meta name="citation_title" content="Contact  Global Youth Science Journal">
  ...
  <meta property="og:title" content="Contact  Global Youth Science Journal">
  <meta property="og:description"
    content="Contact the editorial team of the Global Youth Science Journal for inquiries and support.">
  <meta property="og:url" content="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/contact.php">
  <meta property="og:image" content="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/images/logo.png">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Contact  Global Youth Science Journal">
  ...
  <script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "Contact", "item": "https://<?php echo $_SERVER["HTTP_HOST"]; ?>/contact.php"}
  ]
}
</script>
  <!-- ScholarlyArticle Schema for contact page -->
  <script type="application/ld+json">
{
  "@context": "https://schema.org",
  ...
  "headline": "Contact",
  "name": "Contact",
  "description": "Contact the editorial team of the Global Youth Science Journal for inquiries and support.",
  ...
  "keywords": ["peer-reviewed", "open-access", "research journal", "young scientists", "contact", "science", "technology", "engineering", "mathematics", "STEM", "academic", "global", "youth", "journal", "Google Scholar", "citation", "author guidelines", "editorial board", "call for papers", "free publication", "under 20", "international"]
}
</script>
  <!-- FAQPage Schema -->
  <script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How can I contact the editorial team?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Use the contact form or email globalyouthsciencejournal@gmail.com for support."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "We aim to respond to all inquiries within 3 business days."
      }
    }
  ]
}
...
<body>
  ...
  <div style="display:none;">
    <span itemprop="citation">Global Youth Science Journal Editorial Board. (2026). Contact. Global Youth Science
      Journal. https://<?php echo $_SERVER["HTTP_HOST"]; ?>/contact.php</span>
  </div>
