...
<head>
  ...
  <title>Partners | Global Youth Science Journal</title>
  <meta name="description"
    content="Discover the mission of the Global Youth Science Journal. We empower young researchers worldwide to publish and share innovative research.">
  <meta name="keywords"
    content="mission, Global Youth Science Journal, GYS Journal, empower, young researchers, research publication, global journal">
  ...
  <script type="application/ld+json">
    {
      ...
      "@type": "Article",
      "headline": "Our Mission  Global Youth Science Journal",
      "description": "Discover the mission of the Global Youth Science Journal. We empower young researchers worldwide to publish and share innovative research.",
      "publisher": {
        "@type": "Organization",
        "name": "Global Youth Science Journal",
        "logo": {"@type": "ImageObject", "url": "https://<?php echo $_SERVER["HTTP_HOST"]; ?>/images/logo.png"}
      },
      "mainEntityOfPage": "https://<?php echo $_SERVER["HTTP_HOST"]; ?>/our-mission.php"
    }
    </script>
  <!-- Google tag (gtag.js) -->
  ...
  <link rel="canonical" href="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/our-mission.php" />
  ...
  <meta name="citation_title" content="Our Mission  Global Youth Science Journal">
  <meta name="citation_keywords"
    content="peer-reviewed, open-access, research journal, young scientists, science, technology, engineering, mathematics, STEM, publication, scholarly, academic, global, youth, research paper, submission, journal, scientific publishing, Google Scholar, citation, author guidelines, editorial board, call for papers, free publication, under 20, international, mission">
  <meta property="og:type" content="website">
  <meta property="og:title" content="Our Mission  Global Youth Science Journal">
  <meta property="og:description"
    content="Learn about the mission of the Global Youth Science Journal to empower young researchers.">
  <meta property="og:url" content="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/our-mission.php">
  <meta property="og:image" content="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/images/logo.png">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Our Mission  Global Youth Science Journal">
  ...
  <script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "Our Mission", "item": "https://<?php echo $_SERVER["HTTP_HOST"]; ?>/our-mission.php"}
  ]
}
</script>
  <!-- ScholarlyArticle Schema for mission page -->
  <script type="application/ld+json">
{
  "@context": "https://schema.org",
  ...
  "name": "Our Mission",
  "description": "Learn about the mission of the Global Youth Science Journal to empower young researchers.",
  ...
  "keywords": ["peer-reviewed", "open-access", "research journal", "young scientists", "mission", "science", "technology", "engineering", "mathematics", "STEM", "academic", "global", "youth", "journal", "Google Scholar", "citation", "author guidelines", "editorial board", "call for papers", "free publication", "under 20", "international"]
}
</script>
  <!-- FAQPage Schema -->
  <script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the mission of the journal?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "To provide a global, open-access platform for young researchers to publish and share their work."
      }
    },
    {
      "@type": "Question",
      "name": "How does the journal support young scientists?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "By offering free publication, mentorship, and global visibility for research."
      }
    }
  ]
}
    ...
    <div class="container paddding">
      <div class="row mx-0">
        <div class="col-md-10 animate-box" data-animate-effect="fadeInLeft">
                    <h2>Partners</h2>
          <p style="font-size:1.15em;max-width:800px;">
            Our partners play a crucial role in supporting the Global Youth Science Journal. We collaborate with educational institutions, scientific organizations, and non-profits to empower young researchers.
          </p>
        </div>
      </div>

      <div class="row mx-0 mt-5 justify-content-center text-center">
        <div class="col-md-10 animate-box" data-animate-effect="fadeInUp">
          <hr class="mb-5">
          <a href="https://biomedizone.org" target="_blank" rel="noopener">
            <img src="https://img.itch.zone/aW1nLzE4MzY0MzI2LnBuZw==/original/sHeH31.png" alt="BioMedizone Banner" class="img-fluid mb-4" style="max-width: 800px; width: 100%;">
          </a>
          <h3><a href="https://biomedizone.org" target="_blank" rel="noopener" style="color: #212529; text-decoration: none;">BioMedizone</a></h3>
          <p class="mx-auto" style="font-size:1.1em;max-width:800px;">
            Global Youth Science Journal is proud to partner with BioMedizone, an international student-led initiative focused on advancing biomedical education, research literacy, STEM mentorship, and scientific engagement among young learners.
          </p>
          <p class="mx-auto" style="font-size:1.1em;max-width:800px;">
            United by a shared commitment to expanding access to high-quality research opportunities, our organizations collaborate to support emerging scholars through educational initiatives, mentorship programs, scientific communication, and research-focused activities. Together, we seek to foster a culture of curiosity, innovation, and academic excellence while helping students develop the skills necessary to contribute meaningfully to the global scientific community.
          </p>
          <p class="mx-auto" style="font-size:1.1em;max-width:800px;">
            This partnership reflects our mutual vision of making scientific learning and research more accessible, empowering students from diverse backgrounds, and nurturing the next generation of researchers, healthcare innovators, and scientific leaders.
          </p>
          <p class="mx-auto" style="font-size:1.1em;max-width:800px;">
            Through collaborative programming and community-building efforts, Global Youth Science Journal and BioMedizone continue to strengthen pathways for young people to engage with science, research, and scholarly publishing on a global scale.
          </p>
          <hr class="mt-5">
        </div>
      </div>
...
<div style="display:none;">
  <span itemprop="citation">Global Youth Science Journal Editorial Board. (2026). Our Mission. Global Youth Science
    Journal. https://<?php echo $_SERVER["HTTP_HOST"]; ?>/our-mission.php</span>
</div>
</div>
</div>
</div>
