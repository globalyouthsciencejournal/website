...
<head>
  ...
  <title>Copyright Policy  Global Youth Science Journal | Author Rights</title>
  <meta name="description"
    content="Read the copyright policy of the Global Youth Science Journal. Learn about author rights, open access, and research publication terms.">
  <meta name="keywords"
    content="copyright, policy, author rights, open access, Global Youth Science Journal, GYS Journal, research publication">
  ...
  <script type="application/ld+json">
    {
      ...
      "@type": "Article",
      "headline": "Copyright Policy  Global Youth Science Journal",
      "description": "Read the copyright policy of the Global Youth Science Journal. Learn about author rights, open access, and research publication terms.",
      "publisher": {
        "@type": "Organization",
        "name": "Global Youth Science Journal",
        "logo": {"@type": "ImageObject", "url": "https://<?php echo $_SERVER["HTTP_HOST"]; ?>/images/logo.png"}
      },
      "mainEntityOfPage": "https://<?php echo $_SERVER["HTTP_HOST"]; ?>/copyright.php"
    }
    </script>
  <!-- Google tag (gtag.js) -->
  ...
  <link rel="canonical" href="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/copyright.php" />
  ...
  <meta name="citation_title" content="Copyright  Global Youth Science Journal">
  <meta name="citation_keywords"
    content="peer-reviewed, open-access, research journal, young scientists, science, technology, engineering, mathematics, STEM, publication, scholarly, academic, global, youth, research paper, submission, journal, scientific publishing, Google Scholar, citation, author guidelines, editorial board, call for papers, free publication, under 20, international, copyright">
  <meta property="og:type" content="website">
  <meta property="og:title" content="Copyright  Global Youth Science Journal">
  <meta property="og:description" content="Copyright and licensing information for the Global Youth Science Journal.">
  <meta property="og:url" content="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/copyright.php">
  <meta property="og:image" content="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/images/logo.png">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Copyright  Global Youth Science Journal">
  ...
  <script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "Copyright", "item": "https://<?php echo $_SERVER["HTTP_HOST"]; ?>/copyright.php"}
  ]
}
</script>
  <!-- ScholarlyArticle Schema for copyright page -->
  <script type="application/ld+json">
{
  "@context": "https://schema.org",
  ...
  "headline": "Copyright",
  "name": "Copyright",
  "description": "Copyright and licensing information for the Global Youth Science Journal.",
  ...
  "keywords": ["peer-reviewed", "open-access", "research journal", "young scientists", "copyright", "science", "technology", "engineering", "mathematics", "STEM", "academic", "global", "youth", "journal", "Google Scholar", "citation", "author guidelines", "editorial board", "call for papers", "free publication", "under 20", "international"]
}
</script>
  <!-- FAQPage Schema -->
  <script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What license are articles published under?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "All articles are published under the Creative Commons Attribution 4.0 International License."
      }
    },
    {
      "@type": "Question",
      "name": "Who retains copyright?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Authors retain copyright to their work while granting the journal rights for publication."
      }
    }
  ]
}
...
<body>
      ...
      <div class="row mx-0">
        <div class="col-md-10 animate-box" data-animate-effect="fadeInLeft">
          ...
          <p style="font-size:1.1em;max-width:800px;">
            All research papers published in the Global Youth Science Journal (GYS Journal) are protected by copyright Â©
            2026. By submitting your work to GYS Journal, you agree to the following terms:
          </p>
          <ul style="font-size:1.08em;max-width:800px;">
            <li>You must complete the <a href="https://forms.gle/n86EvNhfp8RnhUzW8" target="_blank">online copyright
                form</a> so that our non-profit journal can publish your research paper.</li>
            <li>By signing the form and submitting your paper, you allow the Global Youth Science Journal to hold the
              copyright for your paper solely for the purposes of publication, distribution, and archiving within the
              journal.</li>
            <li>All published works are archived and indexed on <a href="https://zenodo.org/"
                target="_blank">Zenodo</a>. By submitting, you agree to <a href="https://about.zenodo.org/policies/"
                target="_blank">Zenodo's policies</a> and the <a href="https://creativecommons.org/licenses/by/4.0/"
                target="_blank">Creative Commons Attribution 4.0 International (CC BY 4.0)</a> license.</li>
            <li>You confirm that the paper is your original work, except where sources are properly acknowledged and
              permissions have been obtained if required.</li>
            <li>You confirm that you have the authority to make this agreement, and that you have informed your
              co-author(s), if any, about this copyright arrangement.</li>
          </ul>
          <p style="font-size:1.08em;max-width:800px;">The journal will not use your work for any commercial purposes.
            All rights not expressly granted to the journal remain with the author(s). For any questions regarding
            copyright, please contact <a
              href="mailto:globalyouthsciencejournal@gmail.com">globalyouthsciencejournal@gmail.com</a>.</p>
          <p style="font-size:1.08em;max-width:800px;">We believe in the ideals of open access and support the <a
              href="https://archive.org/details/GuerillaOpenAccessManifesto" target="_blank">Open Access
              Manifesto</a>â€”research should be freely available to all.</p>
          <h3 style="margin-top:32px;">Website Copyright & Usage</h3>
          <p style="font-size:1em;max-width:800px;">All content on this website, including text, images, and design, is
            protected by copyright Â© 2026 Global Youth Science Journal. No part of this website may be reproduced,
            copied, distributed, or transmitted in any form or by any means without prior written permission, except for
            brief quotations in reviews or scholarly work with proper attribution.</p>
          <p style="font-size:1em;max-width:800px;">Â© 2026 Global Youth Science Journal. All rights reserved.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div style="display:none;">
    <span itemprop="citation">Global Youth Science Journal Editorial Board. (2026). Copyright. Global Youth Science
      Journal. https://<?php echo $_SERVER["HTTP_HOST"]; ?>/copyright.php</span>
  </div>
