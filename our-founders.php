...
<head>
  ...
  <title>Our Founders  Global Youth Science Journal | Visionaries Behind GYS Journal</title>
  <meta name="description"
    content="Meet the founders of the Global Youth Science Journal. Discover the vision and leadership that drive our mission to empower young researchers.">
  <meta name="keywords"
    content="founders, visionaries, Global Youth Science Journal, GYS Journal, leadership, young researchers">
  ...
  <script type="application/ld+json">
    {
      ...
      "@type": "Article",
      "headline": "Our Founders  Global Youth Science Journal",
      "description": "Meet the founders of the Global Youth Science Journal. Discover the vision and leadership that drive our mission to empower young researchers.",
      "publisher": {
        "@type": "Organization",
        "name": "Global Youth Science Journal",
        "logo": {"@type": "ImageObject", "url": "https://<?php echo $_SERVER["HTTP_HOST"]; ?>/images/logo.png"}
      },
      "mainEntityOfPage": "https://<?php echo $_SERVER["HTTP_HOST"]; ?>/our-founders.php"
    }
    </script>
  <!-- Google tag (gtag.js) -->
  ...
  <link rel="canonical" href="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/our-founders.php" />
  ...
  <meta name="citation_title" content="Our Founders  Global Youth Science Journal">
  <meta name="citation_keywords"
    content="peer-reviewed, open-access, research journal, young scientists, science, technology, engineering, mathematics, STEM, publication, scholarly, academic, global, youth, research paper, submission, journal, scientific publishing, Google Scholar, citation, author guidelines, editorial board, call for papers, free publication, under 20, international, founders">
  <meta property="og:type" content="website">
  <meta property="og:title" content="Our Founders  Global Youth Science Journal">
  <meta property="og:description"
    content="Meet the founders of the Global Youth Science Journal, dedicated to advancing youth research.">
  <meta property="og:url" content="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/our-founders.php">
  <meta property="og:image" content="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/images/logo.png">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Our Founders  Global Youth Science Journal">
  ...
  <script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "Our Founders", "item": "https://<?php echo $_SERVER["HTTP_HOST"]; ?>/our-founders.php"}
  ]
}
</script>
  <!-- ScholarlyArticle Schema for founders page -->
  <script type="application/ld+json">
{
  "@context": "https://schema.org",
  ...
  "name": "Our Founders",
  "description": "Meet the founders of the Global Youth Science Journal, dedicated to advancing youth research.",
  ...
  "keywords": ["peer-reviewed", "open-access", "research journal", "young scientists", "founders", "science", "technology", "engineering", "mathematics", "STEM", "academic", "global", "youth", "journal", "Google Scholar", "citation", "author guidelines", "editorial board", "call for papers", "free publication", "under 20", "international"]
}
</script>
  <!-- FAQPage Schema -->
  <script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Who founded the journal?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The journal was founded by a group of young scientists and educators passionate about open-access research."
      }
    },
    {
      "@type": "Question",
      "name": "What is the mission of the founders?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "To empower young researchers globally and promote scientific discovery."
      }
    }
  ]
}
...
<body>
    ...
    <div class="container paddding">
      <div class="row mx-0">
        <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
          <h3>Our Founder</h3>
          <div class="founder-profile" style="display:flex;align-items:center;gap:32px;flex-wrap:wrap;">
            <img src="https://www.tuhinsarkar.in/images/profile.png" alt="Tuhin Sarkar Photo"
              style="width:180px;height:180px;object-fit:cover;border-radius:50%;box-shadow:0 2px 12px rgba(0,0,0,0.15);">
            <div>
              <h4 style="margin-bottom:8px;">Tuhin Sarkar</h4>
              <p style="font-size:1.1em;max-width:600px;">My mission is to empower young researchers worldwide by
                providing a free, open-access, and peer-reviewed platform for sharing innovative ideas and scientific
                discoveries. I believe in making research accessible to all, regardless of background, and in nurturing
                the next generation of scientists, thinkers, and creators.</p>
              <p style="margin:8px 0 0 0;">Website: <a href="https://www.tuhinsarkar.in"
                  target="_blank">tuhinsarkar.in</a></p>
              <div style="margin-top:10px;display:flex;flex-wrap:wrap;gap:10px;">
                <a href="https://scholar.google.com/citations?user=vUm5REgAAAAJ&hl=en" target="_blank"
                  style="margin-right:10px;"><i class="fa fa-graduation-cap"></i> Google Scholar</a>
                <a href="http://orcid.org/0009-0001-0439-0646" target="_blank" style="margin-right:10px;"><i
                    class="fa fa-id-badge"></i> ORCID</a>
                <a href="http://youtube.com/@tuhinsarkar_in" target="_blank" style="margin-right:10px;"><i
                    class="fa fa-youtube"></i> YouTube</a>
                <a href="http://instagram.com/tuhinsarkar.in" target="_blank" style="margin-right:10px;"><i
                    class="fa fa-instagram"></i> Instagram</a>
                <a href="https://twitter.com/tuhinsarkar_in" target="_blank" style="margin-right:10px;"><i
                    class="fa fa-twitter"></i> Twitter</a>
                <a href="https://github.com/tuhinsarkar-in" target="_blank" style="margin-right:10px;"><i
  ...
  <div class="col-md-7 animate-box">
    <p class="fh5co_magna py-2">
    </p> <a href="https://en.wikipedia.org/wiki/India" class="fh5co_mini_time py-3">
    </a>
    <div class="fh5co_consectetur">"Å½ </div>
    <br>
  </div>
  </span></span></div>
  </span></span></div>
  ...
  <div style="display:none;">
    <span itemprop="citation">Global Youth Science Journal Editorial Board. (2026). Our Founders. Global Youth Science
      Journal. https://<?php echo $_SERVER["HTTP_HOST"]; ?>/our-founders.php</span>
  </div>
  </div>
  </div>
  </div>
